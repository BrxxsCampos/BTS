          ...
          <Card className="border-2 border-purple-300 shadow-2xl">
            <CardContent className="p-6 sm:p-12 text-center">
              <div className="mb-6 sm:mb-8">
                ...
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-purple-800 mb-6 sm:mb-8 leading-tight sm:leading-relaxed px-2 text-center">✨DESAFIO BTS: Mostre que é um verdadeiro ARMY e ganhe até R$525,00!</h1>
